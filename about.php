            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        ...
                        <h1 class="display-6 mb-5">We Help People In Need Around The city</h1>
                        <div class="bg-light border-bottom border-5 border-primary rounded p-4 mb-4">
                            <p class="text-dark mb-2">Our mission is to provide nourishment and support to individuals and families in need throughout the city. We offer a range of services, including food distribution, meal preparation, and nutritional guidance, to ensure that everyone has access to healthy and nutritious food. Through partnerships with local food banks, grocery stores, and dedicated volunteers, we strive to alleviate food insecurity and foster a stronger, more connected community. Whether it's a hot meal or a pantry staple, we’re here to help make sure no one in our city goes hungry.</p>
