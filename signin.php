        ...
        <div class="container" id="myform">
            <div class="row g-5 align-items-center">
                <div class="col-lg-12 wow fadeIn" data-wow-delay="0.1s">
                    <h1 class="display-6 mb-5">Register Now</h1>
                        ...
                        <form method="POST" action="login.php">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="col-12">
                                        <div class="form-floating">
                                            ...
                                            <label for="address">address/ House No/ flat No/ Area</label>
                                        </div>
                                    </div>    
                                </div>
                                <div class="col-12">
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control bg-light border-0" id="city" name="city" placeholder="City">
                                ...
                                <div class="col-12">
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="password" class="form-control bg-light border-0" id="password" name="password" placeholder="password">
                                ...
                                <div class="col-12">
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="password" class="form-control bg-light border-0" id="cpassword" name="cpassword" placeholder="Confirm password">
...
if (isset($_POST['submit'])) {
    ...
    if ($name!="" && $tel!="" && $email!="" && $address!="" && $city!="" && $password!="" && $cpassword!="" && $password==$cpassword) {

     $query1="insert into signin(nm,tel,email,city,pass,cpass) values('$name','$tel','$email','$city','$password','$cpassword')";
