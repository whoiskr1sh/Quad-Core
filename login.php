                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control bg-light border-0" id="un" name="tel" placeholder="Email or Phone" aria-label="Email or Phone">
                                        <label for="un">Email or Phone</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="password" class="form-control bg-light border-0" id="password" name="password" placeholder="Enter Password" aria-label="Enter Password">
                                ...
                                <div>
                                    <p>You have not registered? <a href="signin.php" class="nav-item nav-link active">Register Now</a></p>
                                </div>
                            </div>
                        </form>
                    </div>
...
if (isset($_POST['submit'])) {
    ...
    if (!empty($tel) && !empty($pass)) {
        ...
        $stmt = $con->prepare("SELECT * FROM signin WHERE tel = ? AND pass = ?");
